        ...
        <div className="px-4 py-4 space-y-4">
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <h1 className="text-xl font-bold text-slate-900 dark:text-slate-100">Exchange Simulator</h1>
            ...
            <div className="max-w-5xl mx-auto space-y-6">
              ...
              {result && !result.error ? (
                <div className="space-y-6">
                  <div className="h-[55vh] min-h-[320px] w-full bg-white dark:bg-slate-900 rounded-3xl lg:rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 p-3 sm:p-4 lg:h-[640px]">
                    <EdgeworthBox
                      data={result}
                      totalResources={totalResources}
                      endowmentA={endowmentA}
